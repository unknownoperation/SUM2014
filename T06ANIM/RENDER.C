...
DBL
  OK2_RndWs = 30.0, OK2_RndHs = 30.0,   /* размеры кадра в точках */
  OK2_RndWp = 4.0, OK2_RndHp = 4.0,     /* размеры обрасти проецирования */
  OK2_RndProjDist = 1.0;              /* расстояние до плоскости проекции */
